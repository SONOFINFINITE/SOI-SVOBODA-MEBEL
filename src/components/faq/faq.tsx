...
const faqData: FaqItem[] = [
    ...
    },
    {
        ...
        answer: 'Сроки доставки зависят от выбранной модели и наличия на складе. Стандартная мебель доставляется в течение 3-5 рабочих дней, мебель на заказ – 30–45 календарных дней. Точные сроки уточняйте у менеджера.'
    },
    {
